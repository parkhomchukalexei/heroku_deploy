...
LEXERS = {
    ...
    'JsonLexer': ('pip._vendor.pygments.lexers.data', 'JSON', ('json', 'json-object'), ('*.json', 'Procfile.lock'), ('application/json', 'application/json-object')),
    ...
    'TOMLLexer': ('pip._vendor.pygments.lexers.configs', 'TOML', ('toml',), ('*.toml', 'Procfile', 'poetry.lock'), ()),
